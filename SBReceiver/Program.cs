...
namespace SBReceiver
{
    class Program
    {
        const string connectionString = "Endpoint=sb://allionservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=MqT6doA3STIitGnyEZpfZTJ24eswF5rN6DP7zs5hxdM=";
